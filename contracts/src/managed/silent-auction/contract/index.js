...
export class Contract {
      ...
      bid: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('bid',
                                     ...
                                     'silent-auction.compact line 38 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      closeAuction: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('closeAuction',
                                     'argument 1 (as invoked from Typescript)',
                                     'silent-auction.compact line 61 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(minPrice_0),
            alignment: _descriptor_3.alignment()
          },
          output: undefined,
          publicTranscript: [],
  ...
  initialState(...args_0) {
    ...
    const hashedPrice_0 = this._commitWithSk_0(__compactRuntime.convertFieldToBytes(32,
                                                                                    _minPrice_0,
                                                                                    'silent-auction.compact line 29 char 38'),
                                               _sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(3n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(maxBidCount_0),
                                                                                              alignment: _descriptor_3.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _revealWin_0(context, partialProofData, minPrice_0) {
    ...
    const hashedPrice_0 = this._commitWithSk_0(__compactRuntime.convertFieldToBytes(32,
                                                                                    minPrice_0,
                                                                                    'silent-auction.compact line 74 char 38'),
                                               _sk_0);
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(2n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(minPrice_0),
                                                                                              alignment: _descriptor_3.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    let t_0;
  ...
  publicKey: (...args_0) => {
    ...
    if (!(_sk_0.buffer instanceof ArrayBuffer && _sk_0.BYTES_PER_ELEMENT === 1 && _sk_0.length === 32)) {
      __compactRuntime.typeError('publicKey',
                                 'argument 1',
                                 'silent-auction.compact line 94 char 1',
                                 'Bytes<32>',
                                 _sk_0)
    }
